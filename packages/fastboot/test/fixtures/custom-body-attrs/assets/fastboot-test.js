...
define('fastboot-test/components/set-body-class', ['exports'], function (exports) {
  'use strict';
  ...
  function getBodyElement(context) {
    return getDOM(context).body;
  }

  exports.default = Component.extend({
    init: function init() {
      this._super.apply(this, arguments);
      var body = getBodyElement(this);
...
define("fastboot-test/templates/application", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "6ODeLWMf", "block": "{\"symbols\":[],\"statements\":[[1,[25,\"set-body-class\",null,[[\"name\"],[\"it-works\"]]],false],[0,\"\\n\"],[1,[18,\"outlet\"],false]],\"hasEval\":false}", "meta": { "moduleName": "fastboot-test/templates/application.hbs" } });
});
define("fastboot-test/templates/components/set-body-class", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "kLdYPuaq", "block": "{\"symbols\":[\"&default\"],\"statements\":[[11,1]],\"hasEval\":false}", "meta": { "moduleName": "fastboot-test/templates/components/set-body-class.hbs" } });
});
