...
function insertHTML(html) {
  indexHTML = indexHTML || fs.readFileSync('app/fastboot.html').toString();

  var output = indexHTML.replace("{{content-for 'body'}}", html);
  output = output.replace(contentForRegex, '');
