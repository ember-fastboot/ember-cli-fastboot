...
module.exports = {
  ...
  /**
   * Augments the applications configuration settings. The object returned from * this hook is merged with the application's configuration object.  * Application's configuration always take precedence.
   */
  config: function() {
    return CONFIG;
  },
