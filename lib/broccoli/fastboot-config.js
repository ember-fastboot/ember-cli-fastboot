...
module.exports = class FastBootConfig extends Plugin {
  ...
  updateFastBootManifest(manifest) {
    this.project.addons.forEach(addon => {
      return recursiveAddonFastBootManifestLookup(addon, manifest);
    });
  }
  ...
  buildManifest() {
    ...
    this.manifest = this.updateFastBootManifest(manifest) || manifest;
  }
...
function recursiveAddonFastBootManifestLookup(addon, manifest) {
  ...
  addon.addons.forEach(addon => {
    manifest = recursiveAddonFastBootManifestLookup(addon, manifest);
    return;
  });
