  ...
  visit(path, options) {
    ...
    return this.buildAppInstance()
      .then(appInstance => {
        ...
        registerFastBootInfo(instance, req, res, this.hostWhitelist);
 ...
 */
function registerFastBootInfo(instance, req, res, hostWhitelist) {
  let info = new FastBootInfo(req, res, hostWhitelist);
